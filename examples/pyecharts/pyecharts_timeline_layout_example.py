...
ot.echarts_Timeline(network2,100,x='lon',y='lat',node_symbol_size=5,line_width=2, path='../html/network_location_layout_timeline3.html',title='location layout timeline', subtitle='London subway stations',layout='none')
